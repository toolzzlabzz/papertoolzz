...
export function OnboardingWizard() {
  ...
  const [model, setModel] = useState(DEFAULT_OPENCODE_LOCAL_MODEL);
          ...
          >
            <div className="w-full max-w-md mx-auto my-auto px-8 py-12 shrink-0">
              ...
              <div className="flex items-center gap-0 mb-8 border-b border-border">
                {(
                  [
                    { step: 1 as Step, label: t("sidebar.company"), icon: Building2 },
                    { step: 2 as Step, label: t("agentDetail.agent"), icon: Bot },
                    { step: 3 as Step, label: t("sidebar.issues"), icon: ListTodo },
                    { step: 4 as Step, label: t("onboarding.step4.launch"), icon: Rocket }
                  ] as const
                ...
                <div className="flex items-center gap-2">
                  {step === 1 && (
                    ...
                    >
                      ...
                      {loading ? "..." : t("onboarding.step1.next")}
                    </Button>
                  )}
                  {step === 2 && (
                    <Button
                    ...
                    >
                      ...
                      {loading ? "..." : t("onboarding.step2.next")}
                    </Button>
                  )}
                  {step === 3 && (
                    <Button
                    ...
                    >
                      ...
                      {loading ? t("onboarding.step1.next") : t("onboarding.step1.next")}
                    </Button>
                  )}
                  {step === 4 && (
                    <Button size="sm" disabled={loading} onClick={handleLaunch}>
                      ...
                      {loading ? "..." : t("onboarding.step4.launch")}
                    </Button>
                  )}
                </div>
              </div>
